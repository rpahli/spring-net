...
namespace Spring.Context.Support
{
    ...
    public class ResourceHandlersSectionHandler : IConfigurationSectionHandler
    {
        ...
        private static string GetRequiredAttributeValue(XmlElement resourceElement, string requiredAttributeName,
            XmlNode section)
        {
            ...
            if (attribute == null)
            {
                string errorMessage =
                    string.Format(CultureInfo.InvariantCulture,
                        "The '{0}' attribute is required for the resource handler definition.",
