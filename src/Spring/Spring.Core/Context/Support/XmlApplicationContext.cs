...
namespace Spring.Context.Support
{
    ...
    public class XmlApplicationContext : AbstractXmlApplicationContext
    {
        ...
        {
            ConfigurationLocations = args.ConfigurationLocations;
            ConfigurationResources = args.ConfigurationResources;
            ...
            if (args.Refresh)
            {
                ...
                if (!hasLocations && !hasResources)
                {
                    throw new ArgumentException(
                        "You must provide either or both Configuration Locations and/or Configuration Resources!");
                }
        ...
        public XmlApplicationContext(
            ...
            IApplicationContext parentContext,
            params string[] configurationLocations)
            : this(new XmlApplicationContextArgs(string.Empty, parentContext, configurationLocations, null,
                caseSensitive, true))
        {
        }
        ...
        public XmlApplicationContext(
            ...
            params string[] configurationLocations)
            : this(
                new XmlApplicationContextArgs(name, parentContext, configurationLocations, null, caseSensitive, true))
        {
        }
        ...
        ///     the responsibility of the deriving class to call <see cref="AbstractApplicationContext.Refresh()" /> to initialize
        ...
        public XmlApplicationContext(
            ...
            : this(new XmlApplicationContextArgs(name, parentContext, configurationLocations, configurationResources,
                caseSensitive, refresh))
        {
        }
        ...
        protected override string[] ConfigurationLocations { get; }
        ...
        /// </returns>
        /// <seealso cref="Spring.Context.Support.AbstractXmlApplicationContext.ConfigurationLocations" />
        protected override IResource[] ConfigurationResources { get; }
    }
}