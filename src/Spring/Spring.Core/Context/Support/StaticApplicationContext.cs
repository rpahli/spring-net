...
namespace Spring.Context.Support
{
    ...
    public class StaticApplicationContext : GenericApplicationContext
    {
        ...
        {
            DefaultListableObjectFactory.RegisterObjectDefinition(name,
                new RootObjectDefinition(classType, propertyValues));
        }
        ...
        {
            DefaultListableObjectFactory.RegisterObjectDefinition(name,
                new RootObjectDefinition(classType, propertyValues, false));
        }
