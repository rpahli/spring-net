...
namespace Spring.Context.Support
{
    ...
    public class ResourceSetMessageSource : AbstractMessageSource, IInitializingObject
    {
        ...
        public ResourceSetMessageSource()
        {
            ...
            ResourceManagers = new List<object>();
        }
        ...
        /// </summary>
        public IList<object> ResourceManagers { get; set; }
        ...
        public void AfterPropertiesSet()
        {
            ...
            {
                object o = ResourceManagers[i];
                if (o is string)
                {
                    ResourceManagers[i] = cvt.ConvertFrom((string) o);
                }
                else if (!(o is ResourceManager))
                {
                    throw new ArgumentException("Only Types of string and ResourceManager are allowed.  Type " +
                                                o.GetType() + " was set instead.");
                }
            }
        }
        ...
        {
            string message = null;
            for (int i = 0; (message == null) & (i < ResourceManagers.Count); i++)
                message = ResolveObject((ResourceManager) ResourceManagers[i], code, cultureInfo) as string;
            return message;
        }
        ...
        protected override object ResolveObject(string code, CultureInfo cultureInfo)
        {
            ...
            for (int i = 0; (obj == null) & (i < ResourceManagers.Count); i++)
                obj = ResolveObject((ResourceManager) ResourceManagers[i], code, cultureInfo);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>
        ///     A <see cref="System.String" /> representation of the
        ///     <see cref="Spring.Context.Support.ResourceSetMessageSource" />.
        /// </returns>
