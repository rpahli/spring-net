...
namespace Spring.Context.Support
{
    ...
    public class XmlApplicationContextArgs : AbstractXmlApplicationContextArgs
    {
        ...
        public XmlApplicationContextArgs(string name, IApplicationContext parentContext,
            string[] configurationLocations, IResource[] configurationResources)
        ...
        public XmlApplicationContextArgs(string name, IApplicationContext parentContext,
            string[] configurationLocations, IResource[] configurationResources, bool caseSensitive, bool refresh)
        {
            Name = name;
