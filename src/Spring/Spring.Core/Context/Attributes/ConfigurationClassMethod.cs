...
namespace Spring.Context.Attributes
{
    ...
    public class ConfigurationClassMethod
    {
        ...
        public ConfigurationClass ConfigurationClass { get; }
        ...
        {
            get { return new Location(ConfigurationClass.Resource, MethodMetadata); }
        }
        ...
        {
            return string.Format("{0}:name={1},declaringClass={2}", GetType().Name, MethodMetadata.Name,
                MethodMetadata.DeclaringType.FullName);
        }
        ...
        public void Validate(IProblemReporter problemReporter)
        {
            ...
            if (
                Attribute.GetCustomAttribute(ConfigurationClass.ConfigurationClassType,
