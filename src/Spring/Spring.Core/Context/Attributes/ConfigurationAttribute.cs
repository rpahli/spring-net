...
namespace Spring.Context.Attributes
{
    ...
    ///     at runtime.
    ///     <para>
    ///         Configuration is meta-annotated as a <see cref="ComponentAttribute" />, therefore Configuration
    ///         classes are candidates for component-scanning.
    ///     </para>
    ///     <para>
    ///         May be used in conjunction with the <see cref="LazyAttribute" /> attribute to indicate that all object
