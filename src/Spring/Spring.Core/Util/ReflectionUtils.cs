...
namespace Spring.Util
{
    ...
    public sealed class ReflectionUtils
    {
        ...
        private static readonly Dictionary<Type, MemberwiseCopyHandler> s_handlerCache =
            ...
            Type targetType, string method, Type[] argumentTypes, int genericArgumentsCount)
        {
            ...
            foreach (MethodInfo candidate in methods)
                ...
                {
                    Type[] parameterTypes = Array.ConvertAll(candidate.GetParameters(),
        ...
        {
#if MONO //no csharp services in mono (verify this!) so have to fall back to returning the ToString() for now
//TODO: investigate whether there is another equivalent manner of providing this functionality under MONO
                ...
                if (f.FieldType != fieldValue.GetType())
                {
                    throw new ArgumentException(
                        string.Format(
                            ...
                            fieldName, obj.GetType().ToString(), f.FieldType.ToString(),
                            fieldValue.GetType().ToString()), "fieldValue");
                }
        ...
        public class CustomAttributeBuilderBuilder
        {
            ...
            {
                object[] caArray = (object[]) constructorArgs.ToArray(typeof(object));
                ConstructorInfo ci = type.GetConstructor(GetTypes(caArray));
                ...
                {
                    PropertyInfo[] npArray = namedProperties.ToArray();
                    object[] pvArray = propertyValues.ToArray();
