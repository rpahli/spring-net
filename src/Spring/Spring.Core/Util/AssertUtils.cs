...
namespace Spring.Util
{
    ...
    public sealed class AssertUtils
    {
        ...
        public static void Understands(object target, string targetName, MethodBase method)
        {
            ...
            if (target == null)
            {
                ...
                throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture,
                    "Target '{0}' is null and target method '{1}.{2}' is not static.", targetName,
        ...
        public static void Understands(object target, string targetName, Type requiredType)
        {
            ...
            if (target == null)
            {
                throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture, "Target '{0}' is null.",
                    targetName));
            }
            ...
            if (RemotingServices.IsTransparentProxy(target))
            {
                ...
                if (rti != null)
                {
                    ...
                    throw new NotSupportedException(string.Format(CultureInfo.InvariantCulture,
                        "Target '{0}' is a transparent proxy that does not support methods of '{1}'.", targetName,
        ...
        public static void ArgumentHasElements(ICollection argument, string name)
        {
            if (!ArrayUtils.HasElements(argument))
            {
                throw new ArgumentException(
                    ...
                    string.Format(
                        CultureInfo.InvariantCulture,
                        "Argument '{0}' must not be null or resolve to an empty collection and must contain non-null elements",
                        name));
            }
        }
