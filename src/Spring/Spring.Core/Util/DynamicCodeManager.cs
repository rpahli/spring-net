...
namespace Spring.Util
{
    ...
    ///     </p>
    ///     <note>
    ///         Using this factory you can't define several modules within a single dynamic assembly - only a simple one2one
    ///         relation between assembly/module is used.
    ///     </note>
    /// </remarks>
    /// <example>
    ...
    {
        private static readonly Hashtable s_moduleCache = new CaseInsensitiveHashtable()
        ...
        public static void SaveAssembly(string assemblyName)
        {
            ...
            if (module == null)
            {
                throw new ArgumentException(string.Format("'{0}' is not a valid dynamic assembly name", assemblyName),
                    "assemblyName");
            }
