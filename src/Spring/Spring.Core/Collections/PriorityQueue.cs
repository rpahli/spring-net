...
namespace Spring.Collections
{
    ...
    public class PriorityQueue : AbstractQueue, ISerializable
    {
        private class PriorityQueueEnumerator : IEnumerator
        {
            ...
            private readonly PriorityQueue _enclosingInstance;
        ...
        private int _priorityQueueSize;

        /// <summary>
        ///     The comparator, or null if priority queue uses elements'
        ///     natural ordering.
        /// </summary>
        private readonly IComparer _comparator;

        /// <summary>
        ///     The number of times this priority queue has been
        ///     <i>structurally modified</i>.
        /// </summary>
        [NonSerialized] private int _queueModificationCount;
        ...
        ///     if elements of <paramref name="collection" /> cannot be
        ///     compared to one another according to the priority queue's ordering
        /// </exception>
        /// <exception cref="System.ArgumentNullException">
        ///     if <paramref name="collection" /> or any element with it is
        ///     <see lang="null" />
        /// </exception>
        ...
        {
            return (int) Math.Min(size * percentage / 100, int.MaxValue - 1);
        }
        ...
        private void grow(int index)
        {
            ...
            {
                throw new InvalidOperationException("Cannot grow queue to accomdate index " + index +
                                                    ".  Doing so would result in a memory overflow.");
            }
            while (newLength <= index)
                if (newLength >= int.MaxValue / 2)
                {
        ...
        /// <returns>
        ///     <see lang="true" /> if the queue contains the <paramref name="element" />,
        ...
        /// </summary>
        /// <returns>
        ///     the comparator used to order this collection, or <see lang="null" />
        ///     if this collection is sorted according to its elements natural ordering.
        /// </returns>
        ...
        public override void CopyTo(Array array, int index)
        {
            ...
            if (index > array.Length - 1)
                throw new ArgumentException("Starting index outside bounds of target array.", "index");
            if (index + _priorityQueueSize > array.Length)
                throw new IndexOutOfRangeException("Destination array not long enough to begin copying at index " +
                                                   index + ".");
        ...
        /// <summary>
        ///     Copies the elements of the <see cref="T:System.Collections.ICollection"></see> to an
        ///     <see cref="T:System.Array"></see>, starting at index 0.
        /// </summary>
        /// <param name="array">
        ///     The one-dimensional <see cref="T:System.Array"></see> that is the destination of the elements
        ///     copied from <see cref="T:System.Collections.ICollection"></see>. The <see cref="T:System.Array"></see> must have
