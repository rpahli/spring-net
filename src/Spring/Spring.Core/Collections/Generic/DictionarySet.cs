...
namespace Spring.Collections.Generic
{
    ...
    ///         types where the underlying data store is an <c>IDictionary</c> instance.
    ///     </p>
    ///     <p>
    ///         You can use any object that implements the <c>IDictionary</c> interface to hold set data.
