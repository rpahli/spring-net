...
namespace Spring.Collections.Generic
{
        ...
        ISet, ICollection, IEnumerable, ICloneable
    {
        ...
        ///     The return value is a <c>Clone()</c> of one of the sets (<c>a</c> if it is not <see langword="null" />) with
        ...
        /// <returns>
        ///     A set containing the union of the input sets.  <see langword="null" /> if both sets are
        ///     <see langword="null" />.
        /// </returns>
        ...
        ///     The result object is a <c>Clone()</c> of one of the input objects (<c>a</c> if it is not <see langword="null" />)
        ///     containing the
