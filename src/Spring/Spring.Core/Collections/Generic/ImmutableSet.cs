...
namespace Spring.Collections.Generic
{
    ...
    ///         <c>basisSet</c> every time you wrap a mutable <c>Set</c>.
    ///     </p>
    /// </summary>
    [Serializable]
    public sealed class ImmutableSet<T> : Set<T>
    {
        ...
        {
            get { return ((ICollection) BasisSet).IsSynchronized; }
        }
        ...
        {
            get { return ((ICollection) BasisSet).SyncRoot; }
        }
        ...
        /// <returns>
        ///     <see langword="true" /> if the set contains all the elements in the specified collection,
        ///     <see langword="false" /> otherwise.
        /// </returns>
        public override bool ContainsAll(ICollection<T> c)
        {
            return BasisSet.ContainsAll(c);
        }
        ...
        {
            return new ImmutableSet<T>(BasisSet);
        }
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        protected override ISet NonGenericUnion(ISet a)
        {
            ISet<T> m = GetUltimateBasisSet();
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        protected override ISet NonGenericMinus(ISet a)
        {
            ISet<T> m = GetUltimateBasisSet();
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        protected override ISet NonGenericIntersect(ISet a)
        {
            ISet<T> m = GetUltimateBasisSet();
        ...
        /// <param name="a"></param>
        /// <returns></returns>
        protected override ISet NonGenericExclusiveOr(ISet a)
        {
            ISet<T> m = GetUltimateBasisSet();
