...
namespace Spring.Collections
{
    ...
    public sealed class ImmutableSet : Set
    {
        ...
        {
            get { return BasisSet.IsSynchronized; }
        }
        ...
        {
            return BasisSet.Contains(element);
        }
        ...
        {
            return BasisSet.ContainsAll(collection);
        }
        ...
        public override ISet Union(ISet setOne)
        {
            ISet m = this;
        ...
        public override ISet Intersect(ISet setOne)
        {
            ISet m = this;
            while (m is ImmutableSet)
                m = ((ImmutableSet) m).BasisSet;
        ...
        public override ISet Minus(ISet setOne)
        {
            ISet m = this;
            while (m is ImmutableSet)
                m = ((ImmutableSet) m).BasisSet;
        ...
        public override ISet ExclusiveOr(ISet setOne)
        {
            ISet m = this;
            while (m is ImmutableSet)
                m = ((ImmutableSet) m).BasisSet;
