...
namespace Spring.Objects.Support
{
    ...
    public abstract class AbstractSharedStateFactory : ISharedStateFactory, IOrdered
    {
        ...
        /// </summary>
        public bool CaseSensitiveState { get; set; }

        /// <summary>
        ///     A number indicating the priority of this <see cref="AbstractSharedStateFactory" /> (<see cref="IOrdered" /> for
        ///     more).
        /// </summary>
        public virtual int Order { get; set; } = int.MaxValue;
        ...
        {
            return CaseSensitiveState ? new Hashtable() : new CaseInsensitiveHashtable();
        }
