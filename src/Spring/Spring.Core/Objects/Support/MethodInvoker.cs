...
namespace Spring.Objects.Support
{
    ...
    public class MethodInvoker
    {
        ...
        ///         <see cref="Spring.Objects.Support.MethodInvoker.Prepare" />
        ...
        protected object[] PreparedArguments
        {
            ...
            set
            {
                if (value != null)
                {
                    _preparedArguments = value;
                }
                else
                {
                    _preparedArguments = new object[] { };
                }
            }
        }
        ...
        public virtual object Invoke()
        {
            ...
            try
            {
                result = _methodObject.Invoke(TargetObject, PreparedArguments);
            }
