...
namespace Spring.Objects
{
    ...
    public class ObjectMetadataAttribute : IObjectMetadataElement
    {
        ...
        public override bool Equals(object other)
        {
            ...
            ObjectMetadataAttribute otherMa = (ObjectMetadataAttribute) other;
            return Name.Equals(otherMa.Name) &&
                   ObjectUtils.NullSafeEquals(Value, otherMa.Value) &&
                   ObjectUtils.NullSafeEquals(Source, otherMa.Source);
        }


        public override int GetHashCode()
        {
            return Name.GetHashCode() * 29 + ObjectUtils.NullSafeHashCode(Value);
        }
