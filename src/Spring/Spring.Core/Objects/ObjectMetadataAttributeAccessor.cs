...
namespace Spring.Objects
{
    ...
    public class ObjectMetadataAttributeAccessor : AttributeAccessorSupport, IObjectMetadataElement
    {
        ...
        {
            ObjectMetadataAttribute attribute = (ObjectMetadataAttribute) base.GetAttribute(name);
            return attribute != null ? attribute.Value : null;
        }

        public override object RemoveAttribute(string name)
        {
            ObjectMetadataAttribute attribute = (ObjectMetadataAttribute) base.RemoveAttribute(name);
            return attribute != null ? attribute.Value : null;
        }
    }
}