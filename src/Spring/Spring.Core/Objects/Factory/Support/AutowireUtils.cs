...
namespace Spring.Objects.Factory.Support
{
    ...
    public sealed class AutowireUtils
    {
        ...
        /// </returns>
        public static bool IsExcludedFromDependencyCheck(PropertyInfo pi)
        {
            ...
            if (setter != null)
            {
                ...
                foreach (Type interfaceType in interfaces)
                    if (interfaceType.IsAssignableFrom(targetType) &&
                        ReflectionUtils.GetMethod(interfaceType, setter.Name,
                            ReflectionUtils.GetParameterTypes(setter)) != null)
                    {
                        return true;
                    }
            }
        ...
        public static IList<PropertyInfo> GetUnsatisfiedDependencies(IList<PropertyInfo> propertyInfos,
            IPropertyValues properties, DependencyCheckingMode dependencyCheck)
        {
