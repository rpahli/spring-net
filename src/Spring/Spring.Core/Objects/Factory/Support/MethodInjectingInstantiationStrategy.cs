...
namespace Spring.Objects.Factory.Support
{
    ...
    public class MethodInjectingInstantiationStrategy : SimpleInstantiationStrategy
    {
        ...
        /// </returns>
        /// <seealso
        ///     cref="Spring.Objects.Factory.Support.SimpleInstantiationStrategy.InstantiateWithMethodInjection(RootObjectDefinition, string, IObjectFactory)" />
        ...
        /// </returns>
        /// <seealso
        ///     cref="Spring.Objects.Factory.Support.SimpleInstantiationStrategy.InstantiateWithMethodInjection(RootObjectDefinition, string, IObjectFactory, ConstructorInfo, object[])" />
        protected override object InstantiateWithMethodInjection(
            RootObjectDefinition definition, string objectName, IObjectFactory factory, ConstructorInfo constructor,
            object[] arguments)
        {
            return DoInstantiate(definition, objectName, factory, ReflectionUtils.GetParameterTypes(constructor),
                arguments);
        }
        ...
        private object DoInstantiate(
            RootObjectDefinition definition, string objectName, IObjectFactory factory, Type[] ctorParameterTypes,
            object[] arguments)
        {
        ...
        private sealed class MethodInjectingTypeBuilder
        {
            ...
            private readonly MethodInfo MethodReplacerImplementMethod
                = typeof(IMethodReplacer).GetMethod("Implement",
                    new[] {typeof(object), typeof(MethodInfo), typeof(object[])});
            ...
            {
                get { return objectDefinition.ObjectType; }
            }
            ...
            private TypeBuilder DefineProperties(TypeBuilder typeBuilder)
            {
                DefineWritePropertyForMethodReplacement(typeBuilder, MethodReplacementPropertyName,
                    methodReplacementField);
                DefineWritePropertyForMethodReplacement(typeBuilder, MethodLookupPropertyName, methodLookupField);
                return typeBuilder;
            }
            ...
            {
                methodReplacementField = typeBuilder.DefineField("methodReplacement", typeof(IMethodReplacer),
            ...
            private TypeBuilder DefineMethods(TypeBuilder typeBuilder)
            {
                ...
                for (int i = 0; i < methods.Length; ++i)
                {
                    ...
                    MethodOverride methodOverride
                        = objectDefinition.MethodOverrides.GetOverride(method);
            ...
            */
                ...
                TypeBuilder typeBuilder, string propertyName, FieldBuilder field)
            {
                MethodBuilder setMethodBuilder = typeBuilder.DefineMethod(
                    ...
                    typeof(void), new[] {typeof(IMethodReplacer)});
