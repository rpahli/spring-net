...
namespace Spring.Objects.Factory.Support
{
    ...
    public class ObjectDefinitionValueResolver
    {
        ...
        /// </param>
        public virtual object ResolveValueIfNecessary(string name, IObjectDefinition definition, string argumentName,
        ...
        ///     The value of the property that is being resolved.
        /// </param>
        private object ResolvePropertyValue(string name, IObjectDefinition definition, string argumentName,
            object argumentValue)
        {
            object resolvedValue = null;
            ...
            {
                resolvedValue = ((ICustomValueReferenceHolder) argumentValue).Resolve(objectFactory, name, definition,
            ...
            else if (argumentValue is ObjectDefinitionHolder)
            {
                ...
                resolvedValue = ResolveInnerObjectDefinition(name, holder.ObjectName, argumentName,
                    holder.ObjectDefinition, definition.IsSingleton);
            }
            else if (argumentValue is IObjectDefinition)
            {
                ...
                resolvedValue =
                    ResolveInnerObjectDefinition(name, "(inner object)", argumentName, def, definition.IsSingleton);
            }
        ...
        /// </returns>
        protected virtual object ResolveInnerObjectDefinition(string name, string innerObjectName, string argumentName,
            ...
            bool singletonOwner)
        {
            ...
            try
            {
                ...
                result = objectFactory.GetObjectForInstance(instance, actualInnerObjectName, actualInnerObjectName,
                    mod);
            }
            catch (ObjectsException ex)
            {
                throw ObjectCreationException.GetObjectCreationException(ex, name, argumentName,
                    definition.ResourceDescription, innerObjectName);
            }
        ...
        private string AdaptInnerObjectName(string innerObjectName)
        {
            string actualInnerObjectName = innerObjectName;
            int counter = 0;
            while (objectFactory.IsObjectNameInUse(actualInnerObjectName))
            {
                counter++;
        ...
        protected virtual object ResolveReference(IObjectDefinition definition, string name, string argumentName,
