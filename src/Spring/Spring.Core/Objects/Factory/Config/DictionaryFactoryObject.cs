...
namespace Spring.Objects.Factory.Config
{
    ...
    public class DictionaryFactoryObject : AbstractFactoryObject
    {
        ...
        protected override object CreateInstance()
        {
            ...
            {
                throw new ArgumentException(
                    "The 'SourceDictionary' property cannot be null (Nothing in Visual Basic.NET).");
            }
            IDictionary result = (IDictionary) ObjectUtils.InstantiateType(_targetDictionaryType);
