...
namespace Spring.Objects.Factory.Config
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:System.Collections.Specialized.NameValueCollection" /> class that is
        ///     empty, has the default initial capacity and uses the default case-insensitive hash code provider and the default
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="T:System.Collections.Specialized.NameValueCollection" /> class that is
        ///     empty, has the specified initial capacity and uses the default case-insensitive hash code provider and the default
        ///     case-insensitive comparer.
        /// </summary>
        /// <param name="capacity">
        ///     The initial number of entries that the
        ///     <see cref="T:System.Collections.Specialized.NameValueCollection" /> can contain.
        /// </param>
