...
namespace Spring.Objects.Factory.Config
{
        ...
        : IObjectFactoryPostProcessor, IOrdered
    {
        ...
        /// </exception>
        /// <seealso
        ///     cref="Spring.Objects.Factory.Config.IObjectFactoryPostProcessor.PostProcessObjectFactory(IConfigurableListableObjectFactory)" />
        ...
        public string[] ConfigSections
        {
            get
            {
                ...
                {
                    _configSections = new[] {DefaultConfigSectionName};
                }
