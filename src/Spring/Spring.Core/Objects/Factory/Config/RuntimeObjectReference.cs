...
namespace Spring.Objects.Factory.Config
{
    ...
    public class RuntimeObjectReference
    {
        ...
        {
            return string.Equals(ObjectName, other.ObjectName) && IsToParent.Equals(other.IsToParent);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                return (ObjectName.GetHashCode() * 397) ^ IsToParent.GetHashCode();
            }
        }
