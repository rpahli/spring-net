...
namespace Spring.Objects.Factory.Config
{
    ...
    public class VariableAccessor
    {
        ...
        ///     The value to be returned if <see cref="IVariableSource.ResolveVariable" /> returns
        ///     <c>null</c>.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        ///     Returns an <see cref="Enum" /> of <paramref name="defaultValue" />'s type that contains the value of the specified
        ///     variable.
        /// </summary>
        /// <param name="name">The name of the variable to be read.</param>
        /// <param name="defaultValue">
        ...
        /// <param name="defaultValue">
        ///     The value to be returned if <see cref="IVariableSource.ResolveVariable" /> returns
        ///     <see lang="null" /> or <see cref="String.Empty" />.
        /// </param>
        /// <returns>
