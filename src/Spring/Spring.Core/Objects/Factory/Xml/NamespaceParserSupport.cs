...
namespace Spring.Objects.Factory.Xml
{
    ...
    {
        private readonly IDictionary<string, IObjectDefinitionParser> objectParsers =
            new Dictionary<string, IObjectDefinitionParser>();
        ...
        private IObjectDefinitionParser FindParserForElement(XmlElement element, ParserContext parserContext)
        {
            ...
            {
                parserContext.ReaderContext.ReportException(element, "unknown object name",
                    "Cannot locate IObjectDefinitionParser for element ["
                    + element.LocalName + "]");
            }
            return parser;
        }
