...
namespace Spring.Objects.Factory.Support
{
    ...
    {
        private readonly StringCollection typeIdentifiers = new StringCollection();
            ...
            : base(methodName)
        {
            ...
            MethodReplacerObjectName = methodReplacerObjectName;
        }
        ...
        ///     instance in the surrounding IoC container.
        /// </summary>
        public string MethodReplacerObjectName { get; }
        ...
        public void AddTypeIdentifier(string identifier)
        {
            ...
            typeIdentifiers.Add(identifier);
        }
        ...
        public override bool Matches(MethodInfo method)
        {
            ...
            if (typeIdentifiers.Count != parameters.Length)
            {
                return false;
            }
            for (int i = 0; i < typeIdentifiers.Count; ++i)
            {
                string identifier = typeIdentifiers[i];
        ...
        public override string ToString()
        {
            return new StringBuilder(GetType().Name).Append(" for method '")
                .Append(MethodName).Append("'; will call object '").Append(MethodReplacerObjectName)
                .Append("'.").ToString();
        }
    }
}