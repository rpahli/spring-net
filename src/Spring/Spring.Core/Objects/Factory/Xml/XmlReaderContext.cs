...
namespace Spring.Objects.Factory.Xml
{
    ...
    public class XmlReaderContext : ReaderContext
    {
        ...
        internal XmlReaderContext(IResource resource, IObjectDefinitionReader reader,
            ...
            : base(resource)
        {
            ...
            {
                NamespaceParserResolver = ((XmlObjectDefinitionReader) reader).NamespaceParserResolver;
            }
        ...
        public IObjectDefinitionReader Reader { get; }
        ...
        public IObjectDefinitionFactory ObjectDefinitionFactory { get; }

        /// <summary>
        ///     Get the <see cref="INamespaceParserResolver" /> instance to lookup parsers for custom namespaces.
        /// </summary>
        internal INamespaceParserResolver NamespaceParserResolver { get; set; }
