...
namespace Spring.Objects.Factory.Xml
{
    ...
    public abstract class AbstractObjectDefinitionParser : IObjectDefinitionParser
    {
                ...
                try
                {
                    ...
                    if (!StringUtils.HasText(id))
                    {
                        parserContext.ReaderContext.ReportException(element, "null",
                            "Id is required for element '" + element.LocalName + "' when used as a top-level tag",
                            null);
                    }
        ...
        ///     provides access to a <see cref="IObjectDefinitionRegistry" />
        /// </param>
        ...
        /// </exception>
        protected virtual string ResolveId(XmlElement element, AbstractObjectDefinition definition,
        ...
        protected virtual void RegisterObjectDefinition(ObjectDefinitionHolder definition,
