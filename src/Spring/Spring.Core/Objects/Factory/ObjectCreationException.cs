...
namespace Spring.Objects.Factory
{
    ...
    public class ObjectCreationException : FatalObjectException
    {
        ...
        protected ObjectCreationException(
            ...
            : base(info, context)
        {
            ResourceDescription = (string) info.GetValue("_resourceDescription", typeof(string));
            ObjectName = (string) info.GetValue("_objectName", typeof(string));
        ...
        /// </summary>
        public string ResourceDescription { get; private set; } = string.Empty;
            ...
            string resourceDescription, string referenceName)
        {
            ...
            if (ocex != null)
            {
                ...
                newCause.AppendFormat("{0} while resolving '{1}' to '{2}' ",
                    Environment.NewLine, propertyName, ocex.ObjectName);
                if (StringUtils.HasText(ocex.ResourceDescription))
                {
                    newCause.Append("defined in '")
                        .Append(ocex.ResourceDescription)
                        .Append("'");
                }
                ...
                ocex.ObjectName = objectName;
                ocex.ResourceDescription = resourceDescription;
                return ocex;
            }
            if (ex is PropertyAccessExceptionsException
