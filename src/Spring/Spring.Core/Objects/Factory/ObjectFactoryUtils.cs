    ...
    public sealed class ObjectFactoryUtils
    {
            ...
            bool includePrototypes, bool includeFactoryObjects)
        {
            ...
            if (pof != null)
            {
                ...
                IList<string> parentsResult =
                    ObjectNamesForTypeIncludingAncestors(pof, type, includePrototypes, includeFactoryObjects);
        ...
        ///     this method will return the same as it's own <see cref="IListableObjectFactory.GetObjectDefinitionNames()" />
        ///     method.
        /// </param>
        /// <param name="type">
        ///     The <see cref="System.Type" /> that objects must match.
            ...
            bool includePrototypes, bool includeFactoryObjects)
        {
            ...
            {
                IHierarchicalObjectFactory hof = (IHierarchicalObjectFactory) factory;
                IDictionary<string, object> parentResult =
                    ObjectsOfTypeIncludingAncestors(pof, type, includePrototypes, includeFactoryObjects);
        ...
        public static object ObjectOfTypeIncludingAncestors(
            ...
            bool includePrototypes, bool includeFactoryObjects)
        {
            IDictionary<string, object> objectsOfType =
                ObjectsOfTypeIncludingAncestors(factory, type, includePrototypes, includeFactoryObjects);
        ...
        {
            return name != null
                   && name.Length > FactoryObjectPrefix.Length
                   && name[0] == FactoryObjectPrefix[0]
                   && name.StartsWith(FactoryObjectPrefix)
                ;
        }
