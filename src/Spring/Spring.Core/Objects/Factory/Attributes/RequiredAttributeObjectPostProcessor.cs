...
namespace Spring.Objects.Factory.Attributes
{
    ...
    public class RequiredAttributeObjectPostProcessor : InstantiationAwareObjectPostProcessorAdapter
    {
        ...
        public Type RequiredAttributeType
        {
            set
            {
                AssertUtils.ArgumentNotNull(value, "RequiredAttributeType",
                    "RequiredAttributeType property must not be null");
            ...
            get { return requiredAttributeType; }
        }
        ...
        /// </returns>
        /// <exception cref="ObjectInitializationException">
