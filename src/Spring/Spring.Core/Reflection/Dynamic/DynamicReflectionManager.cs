...
namespace Spring.Reflection.Dynamic
{
    ...
    public sealed class DynamicReflectionManager
    {
        ...
        /// </summary>
        private static readonly IDictionary<PropertyInfo, IDynamicProperty> propertyCache =
        ...
        /// </summary>
        private static readonly IDictionary<FieldInfo, IDynamicField> fieldCache =
            new Dictionary<FieldInfo, IDynamicField>();
        ...
        /// </summary>
        private static readonly IDictionary<PropertyInfo, IDynamicIndexer> indexerCache =
            new Dictionary<PropertyInfo, IDynamicIndexer>();

        private static readonly object indexerCacheLock = new object();

        /// <summary>
        ///     Cache for dynamic method types.
        /// </summary>
        private static readonly IDictionary<MethodInfo, IDynamicMethod> methodCache =
        ...
        /// </summary>
        private static readonly IDictionary<ConstructorInfo, IDynamicConstructor> constructorCache =
            new Dictionary<ConstructorInfo, IDynamicConstructor>();

        private static readonly object constructorCacheLock = new object();
        ...
        public static FieldGetterDelegate CreateFieldGetter(FieldInfo fieldInfo)
        {
            ...
            System.Reflection.Emit.DynamicMethod dmGetter = CreateDynamicMethod("get_" + fieldInfo.Name, typeof(object),
                argumentTypes, fieldInfo, skipVisibility);
        ...
        public static FieldSetterDelegate CreateFieldSetter(FieldInfo fieldInfo)
        {
            ...
            bool skipVisibility = true; // !IsPublic(fieldInfo);
            System.Reflection.Emit.DynamicMethod dmSetter = CreateDynamicMethod("set_" + fieldInfo.Name, null,
                new[] {typeof(object), typeof(object)}, fieldInfo, skipVisibility);
        ...
        public static PropertyGetterDelegate CreatePropertyGetter(PropertyInfo propertyInfo)
        {
            ...
            NetDynamicMethod dm = CreateDynamicMethod("get_" + propertyInfo.Name, typeof(object),
        ...
        public static PropertySetterDelegate CreatePropertySetter(PropertyInfo propertyInfo)
        {
            ...
            NetDynamicMethod dm = CreateDynamicMethod("set_" + propertyInfo.Name, null, argumentTypes, propertyInfo,
                skipVisibility);
            ILGenerator il = dm.GetILGenerator();
        ...
        public static FunctionDelegate CreateMethod(MethodInfo methodInfo)
        {
            ...
            NetDynamicMethod dm = CreateDynamicMethod(methodInfo.Name, typeof(object),
        ...
        internal static IDynamicProperty GetDynamicProperty(PropertyInfo property,
            CreatePropertyCallback createCallback)
        {
