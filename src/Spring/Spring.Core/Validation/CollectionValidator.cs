...
namespace Spring.Validation
{
    ...
    public class CollectionValidator : BaseValidatorGroup
    {
        ...
        /// </summary>
        public bool IncludeElementErrors { get; set; }
        ...
        public IExpression Context { get; set; }
        ...
        {
            FastValidate = validateAll;
            IncludeElementErrors = includeElementErrors;
        }
