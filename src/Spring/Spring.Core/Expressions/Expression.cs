    ...
    public class Expression : BaseNode
    {
        ...
        public static IExpression Parse(string expression)
        {
            if (StringUtils.HasText(expression))
            {
                ...
                {
                    throw new SyntaxErrorException(ex.recog.Message, ex.recog.getLine(), ex.recog.getColumn(),
                        expression);
                }
        ...
        private class ASTNodeCreator : Parser.antlr.ASTNodeCreator
        {
            ...
            public ASTNodeCreator(ConstructorInfo ctor)
            {
                ...
                ASTNodeTypeName = ctor.DeclaringType.FullName;
            }

            public override string ASTNodeTypeName { get; }
