...
namespace Spring.Expressions.Parser
{
    ...
    internal class ExpressionLexer : CharScanner, TokenStream
    {
                        ...
                        switch (cached_LA1)
                        {
                            ...
                            default:
                                ...
                                else
                                {
                                    ...
                                    {
                                        throw new NoViableAltForCharException(cached_LA1, getFilename(), getLine(),
                                            getColumn());
                                    }
                                }
                                break;
        ...
        public void
            mBACKTICK(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mBACKSLASH(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mLBRACKET(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mRBRACKET(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mNOT_EQUAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mLESS_THAN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mLESS_THAN_OR_EQUAL(
                bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mGREATER_THAN(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mSELECT_FIRST(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mSELECT_LAST(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mDOT_ESCAPED(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mSTRING_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        public void
            mNUMERIC_LITERAL(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
                                ...
                                {
                                    {
                                        ...
                                        for (;;)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                throw new NoViableAltForCharException(cached_LA1, getFilename(),
                                                    getLine(), getColumn());
                                                ;
                                            }
        ...
        protected void
            mDECIMAL_DIGIT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        protected void
            mEXPONENT_PART(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
        ...
        protected void
            mHEX_DIGIT(bool _createToken) //throws RecognitionException, CharStreamException, TokenStreamException
        {
            int _ttype;
            IToken _token = null;
            int _begin = text.Length;
