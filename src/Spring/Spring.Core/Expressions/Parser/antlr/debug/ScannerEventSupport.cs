...
namespace Spring.Expressions.Parser.antlr.debug
{
    ...
    {
        private readonly Hashtable listeners;
        private readonly MatchEventArgs matchEvent;
        private readonly MessageEventArgs messageEvent;

        private readonly NewLineEventArgs newLineEvent;
        //private ParserController controller;

        private int ruleDepth;
        private readonly SemanticPredicateEventArgs semPredEvent;
        private readonly object source;
        private readonly SyntacticPredicateEventArgs synPredEvent;
        private readonly TokenEventArgs tokenEvent;
        private readonly TraceEventArgs traceEvent;
        ...
        {
            ruleDepth++;
            TraceEventHandler eventDelegate =
                (TraceEventHandler) ((CharScanner) source).Events[Parser.EnterRuleEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            TraceEventHandler eventDelegate =
                (TraceEventHandler) ((CharScanner) source).Events[Parser.ExitRuleEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            MatchEventHandler eventDelegate =
                (MatchEventHandler) ((CharScanner) source).Events[Parser.MatchNotEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            MatchEventHandler eventDelegate =
                (MatchEventHandler) ((CharScanner) source).Events[Parser.MisMatchEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            MatchEventHandler eventDelegate =
                (MatchEventHandler) ((CharScanner) source).Events[Parser.MisMatchNotEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            NewLineEventHandler eventDelegate =
                (NewLineEventHandler) ((CharScanner) source).Events[Parser.NewLineEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            MessageEventHandler eventDelegate =
                (MessageEventHandler) ((CharScanner) source).Events[Parser.ReportErrorEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            MessageEventHandler eventDelegate =
                (MessageEventHandler) ((CharScanner) source).Events[Parser.ReportWarningEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            SemanticPredicateEventHandler eventDelegate =
                (SemanticPredicateEventHandler) ((CharScanner) source).Events[Parser.SemPredEvaluatedEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            SyntacticPredicateEventHandler eventDelegate =
                (SyntacticPredicateEventHandler) ((CharScanner) source).Events[Parser.SynPredFailedEventKey];
            if (eventDelegate != null)
            {
        ...
        {
            SyntacticPredicateEventHandler eventDelegate =
                (SyntacticPredicateEventHandler) ((CharScanner) source).Events[Parser.SynPredStartedEventKey];
            if (eventDelegate != null)
            {
                synPredEvent.setValues(0, guessing);
                eventDelegate(source, synPredEvent);
        ...
        {
            SyntacticPredicateEventHandler eventDelegate =
                (SyntacticPredicateEventHandler) ((CharScanner) source).Events[Parser.SynPredSucceededEventKey];
            if (eventDelegate != null)
            {
                synPredEvent.setValues(0, guessing);
                eventDelegate(source, synPredEvent);
