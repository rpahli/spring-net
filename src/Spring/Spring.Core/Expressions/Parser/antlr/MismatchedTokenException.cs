...
namespace Spring.Expressions.Parser.antlr
{
    ...
    */
    ...
    public class MismatchedTokenException : RecognitionException
    {
        ...
        // Expected range / not range
        public MismatchedTokenException(string[] tokenNames_, IToken token_, int lower, int upper_, bool matchNot,
            string fileName_) :
        ...
        // Expected token / not token
        public MismatchedTokenException(string[] tokenNames_, IToken token_, int expecting_, bool matchNot,
            string fileName_) :
            base("Mismatched Token", fileName_, token_.getLine(), token_.getColumn())
        {
            tokenNames = tokenNames_;
        ...
        // Expected BitSet / not BitSet
        public MismatchedTokenException(string[] tokenNames_, IToken token_, BitSet set_, bool matchNot,
            string fileName_) :
            base("Mismatched Token", fileName_, token_.getLine(), token_.getColumn())
        {
            tokenNames = tokenNames_;
            ...
            get
            {
                ...
                switch (mismatchType)
                {
                    ...
                    case TokenTypeEnum.RangeType:
                        sb.Append("expecting token in range: " + tokenName(expecting) + ".." + tokenName(upper) +
                                  ", found '" + tokenText + "'");
                        break;
