    ...
    */
    ...
    public class ASTFactory
    {
        ...
        public ASTFactory(Type nodeType)
        {
            ...
            typename2creator_[typeof(CommonAST).FullName] = CommonAST.Creator;
            typename2creator_[typeof(CommonASTWithHiddenTokens).FullName] = CommonASTWithHiddenTokens.Creator;
        }
        ...
        public void setTokenTypeASTNodeType(int tokenType, string NodeTypeName)
        {
            ...
            {
                throw new ANTLRException("Internal parser error: Cannot change AST Node Type for Token ID '" +
                                         tokenType + "'");
            }
