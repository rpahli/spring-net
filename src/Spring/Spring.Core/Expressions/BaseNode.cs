...
namespace Spring.Expressions
{
    ...
    public abstract class BaseNode : SpringAST, IExpression
    {
        ...
        /// </summary>
        protected object GetValueWithArguments(BaseNode node, object context, EvaluationContext evalContext,
            object[] arguments)
        {
        ...
        protected class EvaluationContext
        {
            ...
            {
                get { return RootContext == null ? null : RootContext.GetType(); }
            }
            ...
            private class ThisContextHolder : IDisposable
            {
                ...
                {
                    this.owner = owner;
                    savedThisContext = owner.ThisContext;
                }
            ...
            private class LocalVariablesHolder : IDisposable
            {
                ...
                {
                    this.owner = owner;
                    savedLocalVariables = owner.LocalVariables;
