...
namespace Spring.Expressions
{
    ...
    public class IndexerNode : NodeWithArguments
    {
        ...
        protected override object Get(object context, EvaluationContext evalContext)
        {
            ...
            catch (TargetInvocationException e)
            {
                throw new InvalidPropertyException(evalContext.RootContextType, ToString(),
                    "Getter for indexer threw an exception.", e);
            }
            ...
            {
                throw new InvalidPropertyException(evalContext.RootContextType, ToString(), "Argument out of range.",
                    e);
            }
        ...
        protected override void Set(object context, EvaluationContext evalContext, object newValue)
        {
            ...
            {
                throw new InvalidPropertyException(evalContext.RootContextType, ToString(),
                    "Setter for indexer threw an exception.", e);
            }
            catch (UnauthorizedAccessException e)
            {
                throw new InvalidPropertyException(evalContext.RootContextType, ToString(),
                ...
                lock (this)
                {
                    if (indexer == null)
                    {
                        ...
                        PropertyInfo indexerProperty =
                            contextType.GetProperty(defaultMember, BINDING_FLAGS, null, null, argTypes, null);
