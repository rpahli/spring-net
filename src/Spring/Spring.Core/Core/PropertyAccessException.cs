...
namespace Spring.Core
{
    ...
    public abstract class PropertyAccessException : ReflectionException, IErrorCoded
    {
        ...
        {
            PropertyChangeArgs = propertyChangeEvent;
        }
        ...
        protected PropertyAccessException(
            ...
            : base(info, context)
        {
            PropertyChangeArgs = info.GetValue("PropertyChangeArgs", typeof(object)) as PropertyChangeEventArgs;
        }

        /// <summary>
        ///     Returns the PropertyChangeEventArgs that resulted in the problem.
        /// </summary>
        public PropertyChangeEventArgs PropertyChangeArgs { get; }
