...
namespace Spring.Core.IO
{
    ...
    ///             <description>
    ///                 <see cref="Spring.Core.IO.ConfigSectionResource" />
    ///             </description>
    ///             <description>
    ...
    ///             <description>
    ///                 <see cref="Spring.Core.IO.FileSystemResource" />
    ///             </description>
    ...
    ///             <description>
    ///                 <see cref="Spring.Core.IO.UrlResource" />
    ///             </description>
    ...
    ///             <description>
    ///                 <see cref="Spring.Core.IO.AssemblyResource" />
    ///             </description>
    ...
    public class ResourceHandlerRegistry
    {
        ...
        public static void RegisterResourceHandler(string protocolName, Type handlerType)
        {
            ...
            lock (syncRoot)
            {
                SecurityCritical.ExecutePrivileged(new SecurityPermission(SecurityPermissionFlag.Infrastructure),
                    delegate
                    {
        ...
        {
            ConstructorInfo ctor = handlerType.GetConstructor(new[] {typeof(string)});
            if (ctor == null)
            {
                throw new ArgumentException(
                    string.Format(
                        "[{0}] does not have a constructor that takes a single string as an argument (it must).",
